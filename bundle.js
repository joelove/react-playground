...
/***/ function(module, exports, __webpack_require__) {
	...
	var CommentBox = (function (_React$Component) {
	  ...
	  function CommentBox() {
	    ...
	    this.loadCommentsFromServer = function () {
	      (0, _isomorphicFetch2['default'])(_this.props.url).then(function (response) {
	    ...
	    this.handleCommentSubmit = function (comment) {
	      (0, _isomorphicFetch2['default'])(_this.props.url, {
	        method: 'POST',
	        headers: {
	    ...
	    value: function render() {
	      var commentNodes = this.state.data.map(function (comment) {
	        return _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(CommentTitle, { title: comment.title }),
	          _react2['default'].createElement(CommentText, { text: comment.text })
	        );
	      });
	      return _react2['default'].createElement(
	        'div',
	...
	var CommentTitle = (function (_React$Component2) {
	  _inherits(CommentTitle, _React$Component2);

	  function CommentTitle() {
	    _classCallCheck(this, CommentTitle);

	    _get(Object.getPrototypeOf(CommentTitle.prototype), 'constructor', this).apply(this, arguments);
	  }
	...
	var CommentText = (function (_React$Component3) {
	  _inherits(CommentText, _React$Component3);

	  function CommentText() {
	    _classCallCheck(this, CommentText);

	    _get(Object.getPrototypeOf(CommentText.prototype), 'constructor', this).apply(this, arguments);
	  }
	...
	var CommentForm = (function (_React$Component4) {
	  ...
	  function CommentForm() {
	    ...
	    this.handleSubmit = function (e) {
	      ...
	      var title = _this2.refs.title.value.trim();
	      var text = _this2.refs.text.value.trim();

	      if (!text || !title) {
	        return;
	      }

	      _this2.props.onCommentSubmit({ title: title, text: text });
	    };
	  }
	...
	_reactDom2['default'].render(_react2['default'].createElement(CommentBox, { url: 'http://localhost:4730', pollInterval: 2000 }), document.getElementById('content'));
